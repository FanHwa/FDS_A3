...
This project is to anaylse a usable dataset from the Australian Government's Safe Work Australia website. The goal for this analysis is to prove the feasilbility of using the dataset to predict the number of injury claims in the future from different factors and provide a customisable insurance plan model based on different customers' characteristics.
...
# Extract the relevant agencies of injury and rename columns in one step
